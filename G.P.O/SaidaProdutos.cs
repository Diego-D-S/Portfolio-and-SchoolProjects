...
namespace G.P.O
{
    public partial class SaidaProdutos : Form
    {
            ...
            else
            {
                try
                {
                    ...
                    for (contador2 = 0; contador2 < linhas; contador2++)
                    {
                        ...
                        pedidoA[contador] = "Cod: " + cod + "    " + "Prod: " + produto + "    " + "Retirado: " + qtd;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String estoqueS = dataGridView1[9, line].Value.ToString();
                int estoque = Int32.Parse(estoqueS);

                String quantidadeS = txt_quantidade.Text;
                int quantidade = Int32.Parse(quantidadeS);
        ...
        private void SaidaProdutos_Load(object sender, EventArgs e)
        {
